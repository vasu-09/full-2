...
public class CallSignalController {
    ...
    public void invite1to1(@DestinationVariable Long roomId,
        ...
        try {
            CallSession s = calls.createInvite(roomId, callerId, dto.getCalleeIds()); // size 1 for 1:1
    ...
    public void inviteGroup(@DestinationVariable Long roomId,
        ...
        try {
            CallSession s = calls.createInvite(roomId, callerId, dto.getCalleeIds()); // >=1
            broker.convertAndSend("/topic/call.room."+roomId, CallEvents.invite(s, callerId, dto.getCalleeIds()));
        } catch (IllegalStateException e) {
            broker.convertAndSendToUser(principal.getName(), "/queue/call", CallEvents.busy(e.getMessage()));
        }
        ...
        try {
            ...
            for (CallSignalIntegrityService.PendingCandidate pc : integrity.markJoined(callId, userId)) {
                broker.convertAndSendToUser(userId.toString(), "/queue/call."+callId,
                        CallEvents.candidate(callId, pc.from, pc.candidate));
            }
        } catch (IllegalStateException e) {
            broker.convertAndSendToUser(principal.getName(), "/queue/call", CallEvents.busy(e.getMessage()));
        }
    ...
    public void answer(@DestinationVariable Long callId,
        ...
        broker.convertAndSend("/topic/call."+callId, CallEvents.answered(callId, userId, dto.getSdp()));
    }
    ...
    public void candidate(@DestinationVariable Long callId,
        ...
        broker.convertAndSend("/topic/call."+callId,
                CallEvents.candidate(callId, from, dto.getCandidate()));
        // Buffer for peers who have not yet joined
        integrity.bufferCandidate(callId, from, dto.getCandidate(), calls.getParticipants(callId));
    }
    ...
    static final class CallEvents {
        static java.util.Map<String,Object> invite(CallSession s, Long from, java.util.List<Long> to){
            java.util.Map<String,Object> m=new java.util.HashMap<>(); m.put("type","call.invite"); m.put("callId",s.getId()); m.put("roomId",s.getRoomId()); m.put("from",from); m.put("callees",to); m.put("topology",s.getTopology()); return m;}
        static java.util.Map<String,Object> ringing(Long id, String who){var m=new java.util.HashMap<String,Object>(); m.put("type","call.ringing"); m.put("callId",id); m.put("by",who); return m;}
        static java.util.Map<String,Object> answered(Long id, Long by, String sdp){var m=new java.util.HashMap<String,Object>(); m.put("type","call.answer"); m.put("callId",id); m.put("by",by); m.put("sdp",sdp); return m;}
        static java.util.Map<String,Object> declined(Long id, Long by){var m=new java.util.HashMap<String,Object>(); m.put("type","call.decline"); m.put("callId",id); m.put("by",by); return m;}
        static java.util.Map<String,Object> ended(Long id, Long by, String reason){var m=new java.util.HashMap<String,Object>(); m.put("type","call.end"); m.put("callId",id); m.put("by",by); m.put("reason",reason); return m;}
        static java.util.Map<String,Object> candidate(Long id, Long by, String cand){var m=new java.util.HashMap<String,Object>(); m.put("type","call.candidate"); m.put("callId",id); m.put("by",by); m.put("candidate",cand); return m;}
        static java.util.Map<String,Object> reinvite(Long id, String by){var m=new java.util.HashMap<String,Object>(); m.put("type","call.reinvite"); m.put("callId",id); m.put("by",by); return m;}
        static java.util.Map<String,Object> join(Long id, Long who){var m=new java.util.HashMap<String,Object>(); m.put("type","call.join"); m.put("callId",id); m.put("userId",who); return m;}
        static java.util.Map<String,Object> leave(Long id, Long who){var m=new java.util.HashMap<String,Object>(); m.put("type","call.leave"); m.put("callId",id); m.put("userId",who); return m;}
        static java.util.Map<String,Object> failed(Long id, Long by){var m=new java.util.HashMap<String,Object>(); m.put("type","call.fail"); m.put("callId",id); m.put("by",by); return m;}
        static java.util.Map<String,Object> busy(String reason){var m=new java.util.HashMap<String,Object>(); m.put("type","call.busy"); m.put("reason",reason); return m;}
        static java.util.Map<String,Object> busy(Long roomId, java.util.List<Long> busy){var m=new java.util.HashMap<String,Object>(); m.put("event","BUSY"); m.put("roomId",roomId); m.put("users",busy); return m;}
    }
}
